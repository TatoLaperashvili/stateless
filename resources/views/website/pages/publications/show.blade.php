            ...
            <div class="parenttpub">
                <div class="content">
                    ...
                    <div class="file-part">
                        ...
                        <a href="/{{config('config.file_path').json_decode($post->translate(app()->getLocale())->locale_additional)->file}}">{{json_decode($post->translate(app()->getLocale())->locale_additional)->name}}</a> 
                    ...
                    <div class="seeealld">
                        <div class="cardd">
                            ...
                            <div class="file-part">
                                ...
                                <img src="/website/img/pdf (1).png" alt="">
                                <a href="/{{config('config.file_path').json_decode($post->translate(app()->getLocale())->locale_additional)->publications->file}}" target="blank">{{json_decode($post->translate(app()->getLocale())->locale_additional)->name}}</a>
                            </div>
                                @endif
                        </div>
                    </div>
